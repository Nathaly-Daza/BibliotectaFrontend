    ...
    <div class="collapse navbar-collapse justify-content-end  m-0 p-0" :class="{ 'show': isMenuOpen }"
      ...
      <div class="menu-items ">
        <div  active-class="active" class="side-title">
          ...
          <RouterLink to="/salones/reservations" @click="closeMenu" active-class="active" class="side-btn">
        ...
        <RouterLink to="/salones/spaces" @click="closeMenu" active-class="active" class="side-btn">
